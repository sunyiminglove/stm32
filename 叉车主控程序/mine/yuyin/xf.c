...
void yinling(u8 num)
{
	switch(num)
	{
		case 0:PrintCom(YIN_LIANG0,9);osdelay_ms(10);speek("这是音量为0的感受");break;
		case 1:PrintCom(YIN_LIANG1,9);osdelay_ms(10);speek("这是音量为1的感受");break;
		case 2:PrintCom(YIN_LIANG2,9);osdelay_ms(10);speek("这是音量为2的感受");break;
		case 3:PrintCom(YIN_LIANG3,9);osdelay_ms(10);speek("这是音量为3的感受");break;
		case 4:PrintCom(YIN_LIANG4,9);osdelay_ms(10);speek("这是音量为4的感受");break;
		case 5:PrintCom(YIN_LIANG5,9);osdelay_ms(10);speek("这是音量为5的感受");break;
		case 6:PrintCom(YIN_LIANG6,9);osdelay_ms(10);speek("这是音量为6的感受");break;
		case 7:PrintCom(YIN_LIANG7,9);osdelay_ms(10);speek("这是音量为7的感受");break;
		case 8:PrintCom(YIN_LIANG8,9);osdelay_ms(10);speek("这是音量为8的感受");break;
		case 9:PrintCom(YIN_LIANG9,9);osdelay_ms(10);speek("这是音量为9的感受");break;
	}                                                                        
}                                 
//语速选择
void yusu(u8 num)
