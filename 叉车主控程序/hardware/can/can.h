...
extern u8 canbuf[8]; //16位磁导航数据缓存
extern u16 CDH16;	//16位磁导航16进制数据存放寄存器
extern u8 canbuf1[8],canbuf2[8],canbuf3[8];
extern u8 CDH8_1,CDH8_2,CDH8_3;
